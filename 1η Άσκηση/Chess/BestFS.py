...
#---------- Heuristic ----------
def h_cheb(state):
    return max(abs(state.wk[0] - state.bk[0]), abs(state.wk[1] - state.bk[1]))
...
expanded, length, path = best_first(start, h_cheb)

# ---------- Εκτύπωση αποτελεσμάτων ----------
print("\nΑΠΟΤΕΛΕΣΜΑΤΑ ΑΛΓΟΡΙΘΜΟΥ BEST-FIRST SEARCH (GREEDY)")
print("--------------------------------------------------")
